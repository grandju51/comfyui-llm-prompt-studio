...
TEMPLATES = {
    ...
    "MiniMax H3 - normal (T2VA, I2VA, FL2VA, L2VA)": (
        ...
        "input order. These are H3's own reference labels: cite them exactly.\n"
        ...
        "is none.\n"
        "SHOTS: [Shot 1] opens with the overall style and the initial composition and "
        "carries NO timestamp, e.g. \"[Shot 1] Live-action, cinematic, a medium-wide "
        "shot frames...\" (styles: Cinematic, live-action, 2D-animated, 3D CG, "
        "claymation, watercolor, vintage film). Every later shot starts with a strictly "
    ...
    "MiniMax H3 - ref (full-reference)": (
        ...
        "last frame or composition anchor: \"<Picture 2> is the first frame of "
        "[Shot 1], showing...\".\n"
        ...
        "generation task. Open with ONE or TWO sentences of overall style BEFORE "
        "[Shot 1] (in reference mode the style goes there, not inside the shot), then "
        "describe shot by shot in playback order. Insert each reference label at its "
        "first real appearance and wherever its role applies, with natural phrasing for "
        "frame anchors: \"the shot begins from <Picture 1>\", \"the shot's keyframe "
        "corresponds to <Picture 2>\", \"the shot ends on <Picture 3>\". Be explicit and "
